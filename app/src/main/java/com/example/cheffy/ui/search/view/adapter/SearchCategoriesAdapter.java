...
public class SearchCategoriesAdapter extends RecyclerView.Adapter<SearchCategoriesAdapter.CategoryViewHolder> {

    private List<Category> categories = new ArrayList<>();
    private final OnCategoryClickListener listener;

    public SearchCategoriesAdapter(OnCategoryClickListener listener) {
